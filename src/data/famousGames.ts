...
export const PDF_RESOURCES = [
  {
    id: 'fide-rules',
    title: 'Legile Șahului',
    description: 'Toate regulile jocului, organizate și explicate — direct în platformă, fără PDF de deschis.',
    url: '/resurse',
    language: 'RO',
    internal: true,
  },
  {
    ...
    description: 'Cum se citesc și se scriu mutările în notație algebrică standard — pe scurt, în română.',
    url: '/resurse/notatie',
    language: 'RO',
    internal: true,
  },
  {
    id: 'tactics-workbook',
    title: 'Antrenament de Tactici',
    description: 'Exersează tactici pe nivelul tău, direct în platformă, cu soluții explicate.',
    url: '/puzzles',
    language: 'RO',
    internal: true,
  },
