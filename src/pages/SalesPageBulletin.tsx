...
const MATRIX: { label: string; free: string; monthly: string; annual: string }[] = [
  ...
  { label: 'Dl. En Passant (antrenor AI)', free: 'curs gratuit', monthly: 'peste tot', annual: 'peste tot' },
...
const FAQ = [
  ...
  { q: 'Chiar e totul în română?', a: 'Da. Cursuri, explicații, antrenorul Dl. En Passant, tot. Fără momente în care un termen în engleză te lasă blocat.' },
            ...
            <div>
              ...
              <div className="mt-8 border-l-2 border-[#E2B340] bg-[#101010] p-5">
                ...
                <p className="mt-3 text-sm leading-relaxed text-[#8A8A8A]">
                  Îl întrebi pe Dl. En Passant „de ce nu merge mutarea asta?" și îți răspunde despre poziția ta
          ...
          <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr] md:items-end">
            ...
            <div>
              <p className="text-[15px] leading-relaxed text-black/75">
                Fă testul de plasament, află-ți nivelul și stilul, încearcă primele cursuri cu Dl. En Passant
