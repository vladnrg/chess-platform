...
SELECT id, 'Linia Clasică (vs d5 Nf6)', 'A', 40.0, 1, 'white',
...
INSERT INTO public.opening_lines (course_id, variation_name, variation_code, popularity_pct, order_index, user_color, moves_uci)
SELECT id, 'Varianta Benoni (vs c5)', 'C', 10.0, 3, 'white',
...
INSERT INTO public.opening_lines (course_id, variation_name, variation_code, popularity_pct, order_index, user_color, moves_uci)
SELECT id, 'Giuoco Piano (vs Bc5)', 'A', 45.0, 1, 'white',
...
INSERT INTO public.opening_lines (course_id, variation_name, variation_code, popularity_pct, order_index, user_color, moves_uci)
SELECT id, 'Clasică (Bf5)', 'A', 35.0, 1, 'black',
...
INSERT INTO public.opening_lines (course_id, variation_name, variation_code, popularity_pct, order_index, user_color, moves_uci)
SELECT id, 'Varianta Avans (vs e5)', 'B', 30.0, 2, 'black',
  'e2e4 c7c6 d2d4 d7d5 e4e5 c8f5 g1f3 e7e6 f1e2 c6c5 e1g1 b8c6 c2c3 d8b6 g3f1 c5c4 f3e1 f5e4'
FROM public.courses WHERE slug = 'caro-kann-defense';
...
INSERT INTO public.opening_lines (course_id, variation_name, variation_code, popularity_pct, order_index, user_color, moves_uci)
SELECT id, 'Winawer (Bb4)', 'A', 25.0, 1, 'black',
