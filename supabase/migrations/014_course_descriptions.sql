...
UPDATE public.courses SET description = 'Deschiderea Catalană combină puterea pionului d4 cu fianchetto-ul nebunului pe g2 — o combinație letală care controlează centrul de la distanță. Jucată de campioni mondiali ca Kasparov și Carlsen, este o alegere sofisticată pentru jucătorii cu stil pozițional.' WHERE slug = 'catalan-opening' AND (description IS NULL OR description = '');
...
UPDATE public.courses SET description = 'Nimzo-Indiana este considerată de mulți cea mai bună apărare la 1.d4. Fb4 pinuiește calul c3 și creează dezechilibre structurale complexe. Alekhine, Botvinnik, Kasprov și Carlsen au jucat Nimzo-Indiana la nivel de Campionat Mondial.' WHERE slug = 'nimzo-indian-defense' AND (description IS NULL OR description = '');
...
UPDATE public.courses SET description = 'Apărarea Pirc lasă centrul albului să se extindă, mizând pe fianchetto-ul nebunului g7 care va exercita presiune latentă. O apărare modernă, asimetrică, care duce la pozilii complexe unde intuiția și calculul sunt mai importante decât memoria de linii.' WHERE slug = 'pirc-defense' AND (description IS NULL OR description = '');
